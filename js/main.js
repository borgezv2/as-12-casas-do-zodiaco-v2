function descobrirCDZ(){
    ...
    else if(data >= '2023/10/21' && data <= '2023/11/21'){
    ...
    else if(data >= '2023/02/21' && data <= '2023/03/21'){
    ...
    else if(data >= '2023/03/21' && data <= '2023/04/21'){
    ...
    else if(data >= '2023/04/21' && data <= '2023/05/21'){
    ...
    else if(data >= '2023/07/21' && data <= '2023/08/21'){
    ...
    else if(data >= '2023/08/21' && data <= '2023/09/21'){
    ...
    else if(data >= '2023/09/21' && data <='2023/10/21'){
    ...
    else if(data >= '2023/12/21' && data <= '2023/01/21'){
    ...
    else if(data >= '2023/01/21' && data <= '2023/02/21'){
